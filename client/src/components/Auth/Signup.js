...
import { signup } from '../../services/authAPI'; // added backend integration
...
const Signup = () => {
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        try {
            await signup(formData); // call backend signup
        ...
        <div className="auth-page">
            <div className="auth-card">
                ...
                <div className="auth-form-panel">
                    <button type="button" aria-label="Close" className="auth-modal-close-btn" onClick={() => navigate('/')}>
                        &times;
                    </button>
                    <h3>Sign up</h3>
                    ...
                    <form onSubmit={onSubmit}>
                        ...
                        <div className="form-input-group">
                            <UsernameIcon />
                            <input type="text" name="username" placeholder="Username" className="form-input" required onChange={handleChange} />
                        </div>
                        <div className="form-input-group">
                            <EmailIcon />
                            <input type="email" name="email" placeholder="Email Address" className="form-input" required onChange={handleChange} />
                        </div>
                        <div className="form-input-group">
                            <PhoneIcon />
                            <input type="tel" name="phoneNumber" placeholder="Phone Number" className="form-input" required onChange={handleChange} />
                        </div>
                        <div className="form-input-group">
                            <PanIcon />
                            <input type="text" name="panNumber" placeholder="PAN Number" className="form-input" required onChange={handleChange} />
                        </div>
                        <div className="form-input-group">
                            <LockIcon />
                            <input type="password" name="password" placeholder="Password" className="form-input" required onChange={handleChange} />
                        </div>
